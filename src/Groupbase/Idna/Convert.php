<?php
namespace Fgsl\Groupware\Groupbase\Idna;
/**
 * From former class of Matthias Sommerfeld
 * @package     Groupbase
...
class Convert
{
    ...
    public function singleton($params = array())
    {
        ...
        if (!isset($instances[$signature])) {
            $instances[$signature] = Convert::getInstance($params);
        }
