<?php
namespace Fgsl\Groupware\Groupbase\Twig;
/**
...
class CallBackLoader implements Twig_LoaderInterface, Twig_SourceContextLoaderInterface, Twig_ExistsLoaderInterface
{
    /**
     * @var int|null
     */
