...
use Fgsl\Groupware\Groupbase\Locale\Math\PhpMath;
...
class Math
{
    ...
    public static $add   = array('Fgsl\Groupware\Groupbase\Locale\Math', 'Add');
    public static $sub   = array('Fgsl\Groupware\Groupbase\Locale\Math', 'Sub');
    public static $pow   = array('Fgsl\Groupware\Groupbase\Locale\Math', 'Pow');
    public static $mul   = array('Fgsl\Groupware\Groupbase\Locale\Math', 'Mul');
    public static $div   = array('Fgsl\Groupware\Groupbase\Locale\Math', 'Div');
    public static $comp  = array('Fgsl\Groupware\Groupbase\Locale\Math', 'Comp');
    public static $sqrt  = array('Fgsl\Groupware\Groupbase\Locale\Math', 'Sqrt');
    public static $mod   = array('Fgsl\Groupware\Groupbase\Locale\Math', 'Mod');
