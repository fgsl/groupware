...
use Fgsl\Groupware\Groupbase\Locale\Format;
...
class Date extends DateObject
{
                    ...
                    case 'cache' :
                        if ($value === null) {
                            ...
                            if (!$value instanceof CacheInterface) {
                                throw new Exception("Instance of CacheInterface expected");
                            }
     ...
     * @return Date New clone with requested part
     */
    ...
    private function _assign($calc, $date, $comp = 0, $dst = false)
    {
        switch ($calc) {
            case 'set' :
                if (!empty($comp)) {
                    $this->setUnixTimestamp(call_user_func(Locale_Math::$sub, $this->getUnixTimestamp(), $comp));
                }
                $this->setUnixTimestamp(call_user_func(Locale_Math::$add, $this->getUnixTimestamp(), $date));
            ...
            case 'add' :
                ...
                break;
            case 'sub' :
                $this->setUnixTimestamp(call_user_func(Locale_Math::$sub, $this->getUnixTimestamp(), $date));
                $value = $this->getUnixTimestamp();
                break;
            default :
                // cmp - compare
                return call_user_func(Locale_Math::$comp, $comp, $date);
                break;
        }
     ...
     * @param  string                          $format  OPTIONAL Timeformat for parsing input
     * @param  string|Locale              $locale  OPTIONAL Locale for parsing input
     * @return Date Provides a fluent inteface
     * @throws Exception
     */
     ...
     * For a list of cities and correct locations use the class Date_Cities
     *
     ...
     * Returned is the new date object
     *
     * @param  string|integer|array|Date  $year    Year to set
     * @param  string|Locale              $locale  OPTIONAL Locale for parsing input
     * @return Date Provides a fluent interface
     * @throws Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|array|Date  $year    Year to add
     * @param  string|Locale              $locale  OPTIONAL Locale for parsing input
     * @return Date Provides a fluent interface
     * @throws Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|array|Date  $year    Year to sub
     * @param  string|Locale              $locale  OPTIONAL Locale for parsing input
     * @return Date Provides a fluent interface
     * @throws Exception
     */
     ...
     *
     * @param string      $calc   Type of calculation to make
     * @param Date   $day    Day to calculate, when null the actual day is calculated
     * @param Locale $locale Locale for parsing input
     * @throws Exception
     * @return Date|integer
     */
     ...
     *
     * @param  string|integer|array|Date  $day     Day to set
     * @param  string|Locale              $locale  OPTIONAL Locale for parsing input
     * @return Date Provides a fluent interface
     * @throws Exception
     */
     ...
     * set locale.
     *
     * @param  string|integer|array|Date  $day     Day to add
     * @param  string|Locale              $locale  OPTIONAL Locale for parsing input
     * @return Date Provides a fluent interface
     * @throws Exception
     */
     ...
     * set locale.
     *
     * @param  string|integer|array|Date  $day     Day to sub
     * @param  string|Locale              $locale  OPTIONAL Locale for parsing input
     * @return Date Provides a fluent interface
     * @throws Exception
     */
     ...
     *
     * @param  string      $calc     Type of calculation to make
     * @param  Date   $weekday  Weekday to calculate, when null the actual weekday is calculated
     * @param  Locale $locale   Locale for parsing input
     * @return Date|integer
     * @throws Exception
     */
     ...
     *
     * @param  string|integer|array|Date  $weekday Weekday to set
     * @param  string|Locale              $locale  OPTIONAL Locale for parsing input
     * @return Date Provides a fluent interface
     * @throws Exception
     */
     ...
     * wednesday.
     *
     * @param  string|integer|array|Date  $weekday Weekday to add
     * @param  string|Locale              $locale  OPTIONAL Locale for parsing input
     * @return Date Provides a fluent interface
     * @throws Exception
     */
     ...
     * wednesday.
     *
     * @param  string|integer|array|Date  $weekday Weekday to sub
     * @param  string|Locale              $locale  OPTIONAL Locale for parsing input
     * @return Date Provides a fluent interface
     * @throws Exception
     */
     ...
     *
     * @param  string|Locale $locale (Optional) Locale for parsing input
     * @throws Exception When the given locale does not exist
     ...
     *
     * @param  string|array|Date $date   Date to parse for correctness
