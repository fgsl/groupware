        ...
        if ($this->_operator == 'within') {
            switch ($this->_value) {
                ...
                case 'yearLast':
                    ...
                    $like = $date->format('Y') . '-%';
                    break;
                default: throw new InvalidArgument('The value for the within operator is not supported: ' . $this->_value);
            }
            ...
            switch ($this->_operator) {
                ...
                case 'after_or_equals':
                    ...
                    break;
                default:
                    throw new InvalidArgument('The operator ' . $this->_operator . ' is not supported for this filter!');
            }
        }
    }
}