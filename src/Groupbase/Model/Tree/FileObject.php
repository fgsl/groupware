 ...
 */
class FileObject extends AbstractRecord
{
    /**
    ...
    protected $_validators = array (
        ...
        'id'                    => array(Input::ALLOW_EMPTY => true, Input::DEFAULT_VALUE => NULL),
        ...
        'revision'              => array(Input::ALLOW_EMPTY => true),
        'available_revisions'   => array(Input::ALLOW_EMPTY => true),
        'description'           => array(Input::ALLOW_EMPTY => true),
        'contenttype'           => array(Input::ALLOW_EMPTY => true, Input::DEFAULT_VALUE => 'application/octet-stream'),
        'size'                  => array(Input::ALLOW_EMPTY => true, 'Digits', Input::DEFAULT_VALUE => 0),
        'revision_size'         => array(Input::ALLOW_EMPTY => true, 'Digits'),
        'preview_count'         => array(Input::ALLOW_EMPTY => true, 'Digits', Input::DEFAULT_VALUE => 0),
        'hash'                  => array(Input::ALLOW_EMPTY => true),
        'indexed_hash'          => array(Input::ALLOW_EMPTY => true),
        'type'                  => array(
            'presence' => 'required',
            array('InArray', array(self::TYPE_FOLDER, self::TYPE_FILE, self::TYPE_PREVIEW))
        ),
        'lastavscan_time'       => array(Input::ALLOW_EMPTY => true),
        'is_quarantined'        => array(Input::ALLOW_EMPTY => true),
    );
     ...
     *
     * @param   string|ModelList  $_listId  the contact id to convert
     * 
     * @return  string
